...
class ItemRecommender(ItemBasedRecommender):
    ...
    recommenders.
    '''
    def __init__(self, model, similarity, itemStrategy, capper=True,**args):
        '''
        UserBasedRecommender Class Constructor
        ...
        self.similarity = similarity
        self.capper = capper
        addSimilarity=args.get('addSimilarity', None) #list of similarity
    ...
    def estimatePreference(self, **args):
        ...
        itemID = args.get('itemID', None)
        similarity = args.get('similarity', self.similarity)
        topicDistribution=args.get('topicDistribution',False)
        movieIndex=args.get('movieIndex',None)
